    ...
    public class DiContainer 
    {
        ...
        public object Resolve(Type parameter,string tag = null)
        {
            try
            {
                ...
                {
                    var reg = _sceneRegistrations.FirstOrDefault((kv) => kv.Key.Registration.Tag == tag).Value;
                    
                    if(reg == null)
                        reg = _projectRegistrations.FirstOrDefault((kv) => kv.Key.Registration.Tag == tag).Value;
