...
namespace DI
{
    ...
    public abstract class Context : MonoBehaviour
    {
        ...
        public Registration Register<TService, TImplementation>(bool isSingleton) where TImplementation : TService
        {
            ...
            _registrations[new TypeTagPair(){Type = typeof(TService),Registration = registration}] = registration;
        ...
        public Registration Register<TService>(bool isSingleton)
        {
            var registration = new Registration
            {
        ...
        /// <typeparam name="TService">The dependency type</typeparam>
        public Registration RegisterFromInstance<TService>(TService instance)
        {
            var registration = new Registration
            {
                Factory = () => instance,
        ...
        /// <typeparam name="TService">The dependency type</typeparam>
        public Registration RegisterFactory<TService>(Func<object> factory)
        {
            var registration = new Registration
            {
                Factory = factory ,
        ...
        public Registration RegisterFromScene<TService>() where TService : Object
        {
        ...
        public Registration RegisterFromScene<TService>(string name) where TService : Object
        {
        ...
        public Registration RegisterMonoBehavior<TService>(TService prefab, bool isSingleton) where TService : MonoBehaviour
        {
            if (prefab == null)
            {
        ...
        /// <typeparam name="TService">The base type</typeparam>
        /// <typeparam name="TImplementation">The implementation type</typeparam>
        public Registration RegisterWithParameters<TService, TImplementation>(bool isSingleton, params object[] parameters) where TImplementation : TService
        {
            var registration = new Registration
            {
        ...
        public Registration RegisterWithParameters<TImplementation>(bool isSingleton, params object[] parameters)
        {
            var registration = new Registration
            {
                Factory = () => CreateInstanceWithParameters<TImplementation>(parameters),
            ...
            _registrations[new TypeTagPair(){Type = typeof(TImplementation),Registration = registration}] = registration;
